...
export function Panel({
  ...
  return (
    <section className={cn('overflow-hidden rounded-lg border border-border bg-card', className)}>
      ...
      <div className={cn(title ? 'p-4' : 'p-4', bodyClassName)}>{children}</div>
    </section>
  )
}
...
export function EmptyState({
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-lg border border-dashed border-border bg-card/40 px-6 py-14 text-center">
      {Icon && (
        <span className="mb-3 grid size-11 place-items-center rounded-lg bg-secondary text-muted-foreground">
