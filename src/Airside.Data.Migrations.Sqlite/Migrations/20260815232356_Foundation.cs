        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserEmailSnapshot = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    Action = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    Result = table.Column<string>(type: "TEXT", maxLength: 16, nullable: false),
                    ResourceKind = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    ResourceId = table.Column<Guid>(type: "TEXT", nullable: true),
                    ResourceSlugSnapshot = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CapacityCpuNanos = table.Column<long>(type: "INTEGER", nullable: false),
                    CapacityMemoryBytes = table.Column<long>(type: "INTEGER", nullable: false),
                    CapacityStorageBytes = table.Column<long>(type: "INTEGER", nullable: false),
                    ReserveCpuNanos = table.Column<long>(type: "INTEGER", nullable: false),
                    ReserveMemoryBytes = table.Column<long>(type: "INTEGER", nullable: false),
                    ReserveStorageBytes = table.Column<long>(type: "INTEGER", nullable: false),
                    StorageEnforcement = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    VolumeRoot = table.Column<string>(type: "TEXT", maxLength: 512, nullable: false),
                    DockerApiVersion = table.Column<string>(type: "TEXT", maxLength: 32, nullable: true),
                    KernelVersion = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    OperatingSystem = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    LastDiscoveredAt = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    InstanceName = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    DashboardDomain = table.Column<string>(type: "TEXT", maxLength: 253, nullable: true),
                    StoreProvider = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    CurrentImageTag = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    PreviousImageTag = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    UpdateChannel = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    SetupCompletedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    SetupTokenHash = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    SetupTokenExpiresAt = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkloadId = table.Column<Guid>(type: "TEXT", nullable: true),
                    Status = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    ProgressPercent = table.Column<int>(type: "INTEGER", nullable: false),
                    CurrentStep = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Reference = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    CreatedByThisJob = table.Column<bool>(type: "INTEGER", nullable: false),
                    CompensatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    RowVersion = table.Column<Guid>(type: "TEXT", nullable: false)
                },
            ...
            // Append-only audit. SQLite has no GRANT system, so the equivalent
            // guarantee is a pair of BEFORE triggers that abort the statement.
