        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnvKeyPrefix = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    CredentialId = table.Column<Guid>(type: "TEXT", nullable: false),
                    AttachedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    AttachedByUserId = table.Column<Guid>(type: "TEXT", nullable: true),
                    DetachedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    DetachedByUserId = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceKindSnapshot = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    CommitSha = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    CommitMessage = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: true),
                    Branch = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    ImageRef = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
                    ...
                    RolledBackFromDeploymentId = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Value = table.Column<string>(type: "TEXT", maxLength: 32768, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsRegistry = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_database_attachments_ApplicationId_DatabaseInstanceId_DetachedAt",
